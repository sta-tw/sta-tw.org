  ...
  return (
    <article className="group flex h-full cursor-pointer flex-col overflow-hidden rounded-[var(--radius-panel)] border border-ink/10 bg-white shadow-[var(--shadow-card)] transition-transform duration-300 hover:-translate-y-1">
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        <div className="absolute left-5 top-5 inline-flex rounded-full bg-white/88 px-3 py-1 text-sm font-semibold text-ink shadow-sm">
          {article.category}
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col gap-5 p-5 sm:p-6">
        ...
        <div className="space-y-3">
          <h3 className="text-balance font-serif text-[1.75rem] leading-tight text-ink">
            {article.title}
          </h3>
